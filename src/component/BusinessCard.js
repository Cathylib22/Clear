  ...
  return (
    <section className="bdg-sect" id="ipo08g">
      <div className="container-width" id="i4xku8">
        <h1 className="bdg-title">CalcSim</h1>
        <h4>
          "A boutique marketing firm established in 1998 located in Irvine, CA,
          near the ports of Newport Beach and Los Angeles"
        </h4>
        <div className="badges" id="ike41j">
          <div className="badge" id="iiofth">
            ...
            <div className="badge-body">
              <div className="badge-name">Catherine Yang</div>
              <div className="badge-role">PARTNER</div>
              <div className="badge-desc"></div>
            </div>
